...
export default function SupporterSignup(props) {
  ...
  async function handleSubmit(e) {
    ...
    const dict = {"nickname": nicknameRef.current.value, "email": emailRef.current.value, "password": passwordRef.current.value,
     "school": schoolRef.current.value, "specialty": specialtyRef.current.value, "story": storyRef.current.value,
    "whyPeerUp": whyPeerUpRef.current.value};
    ...
    <Card>
      <Card.Body>
        ...
        <Form onSubmit={handleSubmit}>
          ...
          <Form.Group className={styles.form}>
            {/* <Form.Label>Email</Form.Label> */}
            <Form.Control type="story" placeholder="About you" ref={storyRef} />
          </Form.Group>
          <Form.Group className={styles.form}>
            {/* <Form.Label>Email</Form.Label> */}
            <Form.Control type="whypeerupx" placeholder="Why are you joining PeerUpX?" ref={whyPeerUpRef} />
          </Form.Group>
          <Form.Group className={styles.form}>
